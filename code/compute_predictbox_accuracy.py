...
'''
 ...
 @Author:  wu xia
 @File  :  compute_predictbox_accuracy.py
 @6:计算测试集上预测框的准确率(AP):执行该Py文件，在model_AP/AP下就可以看到自己的mAP啦！！
'''
...
GT_PATH = os.path.join(os.getcwd(), 'model_AP', 'ground_truth')
DR_PATH = os.path.join(os.getcwd(), 'model_AP', 'detection_results')
IMG_PATH = os.path.join(os.getcwd(), 'test_images')
# IMG_PATH = os.path.join(os.getcwd(), 'model_AP', 'images_optional')  # if there are no images then no animation can be shown
...
output_files_path = "model_AP_output"
